public class Variables {
     ...
     *
     * Syntax:
     *  <access_specifier> <access_modifier> <type> <name> = ...;
     *
     *
     * Primitive types - boolean, byte, short, int, long, float, double, char
     * Reference types - Boolean, Byte, Short, Integer, Long, Float, Double, Character, String and all class ojects
     */
    ...
    public static void main(String[] args) {
        ...
        int value1 = 100;
        Integer value2 = 200;
        Integer value1Copy = value1;
        Integer value2Copy = value2;
